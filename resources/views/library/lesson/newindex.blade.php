                    ...
                    <div class="sidebar mb-5">
                        <ul class="">
                            ...
                            @foreach ($cateOptions as $cateOption)
                                <li @if($cateOption['id'] == $id) class="act p-20" @else class="p-20" @endif >
                                    <div class="main-nav__drop-holder main-nav__drop-parent">
                                        <a href="javascript:void(0);" class="main-nav__drop-parent">
                                            ...
                                            <span> {{ $cateOption['title'] }} <span class="badge rounded-pill bg-info text-dark">{{CalculateCountHelper::calculateCount($cateOption['id'])}}</span></span>
                                        </a>
                                        <div class="main-nav__drop">
                                            <ul class="main-nav__drop-list">
                                                @for ($i = 1; $i <= $cateOption['course']; $i++)
                                                    <li class="main-nav__drop-item">
                                                        <a href="/library_manual/{{ $cateOption['id'] }}?course={{ $i }}">{{ $i }}
                                                            - kurs
                                                           <span class="badge rounded-pill bg-info text-dark">{{CalculateCountHelper::calculateCount($cateOption['id'],$i)}}</span></a>
                                                    </li>
                                                @endfor
                                            </ul>
                                        </div>
                        ...
                        <form class="form-inline d-flex justify-content-center" method="GET">
                            <div class="form-group mx-sm-3 w-50">
                                <select class="form-control select-two" id="select-country" data-live-search="true"
                                    ...
                                    @foreach($libSubject as $key=>$subject)
                                        <option value="{{$subject['id']}}"
                                                @if(request('subject') == $subject['id']) selected @endif>{{ $subject['name'] }} &af;  ({{$subject->books_count}})</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group mx-sm-3 ">
                                <select class="form-select select-two w-100" name="category">
                                    ...
                                    @foreach($subCategory as $key=>$subCte)
                                        <option value="{{$key}}"

                                                @if(request('category') == $key) selected @endif>{{ $subCte }}</option>
                            ...
                            <div class="form-group mx-sm-3 ">
                                <select class="form-select select-two w-100" name="year">
                                    ...
                                    @foreach($eduYears as $key=>$eduYear)
                                        <option value="{{$key}}"
                                                @if(request('year') == $key) selected @endif>{{ $eduYear }}</option>
                                    @endforeach
                                </select>
                            </div>
                                    ...
                                    <article>
                                        ...
                                        <div class="books_footer">
                                            ...
                                            <path
                                                ...
                                                fill="#285BAD"/>
                                        </svg> {{$item->download_count}}</span> <span>
