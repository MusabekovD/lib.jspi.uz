                ...
                <div class="col-md-3 mb-5 mb-lg-0">
                    <div class="list-group">
                        @foreach ($categories as $item)
                            <a href="https://lib.jdpu.uz/library?category={{ $item->id }}" class="list-group-item list-group-item-action">
                ...
                <div class="col-md-9 mb-5 mb-lg-0">
                    <div class="row">
                        ...
                        <div class="col-md-8 mb-5">
                            ...
                            <br />
                            <div class="d-flex">
                                <a class="btn btn-primary mr-3" target="_blank" href="{{ $books->getFile() }}" role="button">Yuklab olish</a>
                            </div>
                        </div>
                    </div>
                    <div class="row">
